...
// at the beginning of lecture 151, given all the notes, I created a new file below without
// the notes so we are starting fresh
...
import { FaSearch } from 'react-icons/fa';
// import in Font Awesome times icon
import { FaTimes } from 'react-icons/fa';
// import in the scss file
import styles from './search-box-v3.module.scss';


export default function SearchBoxComponent( { resetShowSearchBox, onSearch } ) {
    ...
    // use the useRef(); hook to create a reference to a DOM element and let's start by
    // initializing one useRef variables
    const searchBoxContainerRef = useRef();
    ...
    const handleClickOutside = useCallback( ( e ) => {
        ...
        if (
            ...
            // call resetSearchBox and this will change the showSearchBox state in the nav.js
            // file, thereby closing the search box
            resetShowSearchBox();

        }

    }, [ resetShowSearchBox ] ); // end of handleClickOutside
    ...
    const handleKeyPress = useCallback( ( e ) => {
        ...
        // if the escape key is pressed then close the search box
        if ( e.key === "Escape" ) {
    ...
    }, [ resetShowSearchBox ] ); // end of handleKeyPress
    ...
    return (
        ...
        >
            ...
            <form noValidate="novalidate" onSubmit={ handleSubmit }>
                ...
                { /*  on search button  */ }
                <div 
                    className={ styles.searchBoxContainerFormButtonContainer }
                >

                    <button>
                        <FaSearch style={ { verticalAlign: '-3px', fontSize: '1.8rem' } } />
                    </button>
            ...
            { /*  close the search box button */ }
            <div 
                className={ styles.searchBoxContainerCloseSearchContainer }
            >
        
                <button
                    onClick={ () => resetShowSearchBox() }
                >
                    <FaTimes style={ { verticalAlign: '-2px', fontSize: '1.8rem' } } />
                </button>

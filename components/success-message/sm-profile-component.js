...
import styles from './sm-profile-component.module.scss';
...
export default function SuccessMessageProfileComponent( { children, resetFrontendSuccessMessage } ) {
...
} // end of SuccessMessageProfileComponent() {}

...
import styles from './sm-register-component.module.scss';
...
export default function SuccessMessageRegistrationComponent( { children, resetFrontendSuccessMessage } ) {
...
} // end of SuccessMessageRegistrationComponent() {}

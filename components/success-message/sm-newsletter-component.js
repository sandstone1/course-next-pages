...
import styles from './sm-newsletter-component.module.scss';
...
export default function SuccessMessageNewsletterComponent( { children, resetFrontendSuccessMessage } ) {
...
} // end of successMessageNewsletterComponent() {}

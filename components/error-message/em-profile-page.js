...
import styles from './em-profile-page.module.scss';
...
const ErrorMessage = ( { children, setFrontendErrorMessage, onClose } ) => {
    ...
    const handleClick = ( e ) => {
        ...
        // after closing the error message, reset the userUpdatePasswordError to null and we
        // can do that by calling onClose(); in this component and this will call the onClose
        // function in the profile.js file and thereby reset the userUpdatePasswordError to
        // null
        onClose();

...
import styles from './em-register-component.module.scss';
...
export default function ErrorMessageRegistrationComponent( { children, resetFrontendErrorMessage } ) {
...
} // end of ErrorMessageRegistrationComponent() {}

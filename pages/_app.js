...
// import in UserState
import UserState from '../context/user/user-state';
// import in SearchTermState
import SearchTermState from '../context/search/search-state';
...
const App = ( { Component, pageProps } ) => {
    ...
    return (
        ...
        // wrap everthing below in the UserState and SearchTermState components and these
        // components serve as our app level state
        <UserState>
